...
demo = {
  ...
  initMyFunc: function()
  {
    // console.log("Function is Called which is used two vars");
    // var myVar = document.getElementById('firstVar');
    // myVar.innerText = "This is firstfirstfirstfirstfirst Var"; 
  ...
  UpdateData : function(dataFirebase) { 
    ...
    firstGuage.setAttribute("data-value", demo.getVolts(1, 220));
    secondGuage.setAttribute("data-value", demo.getVolts(1, 220));

    // BigOne.innerText = data.child('lastUpdatedTime').val();
    // BigTwo.innerText = data.child('packVoltage').val();
    // BigThree.innerText = data.child('packCurrent').val();

  },

  getVolts : function(min, max) { 
